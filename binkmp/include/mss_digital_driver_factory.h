...
#ifndef BINK_MP_INCLUDE_IMSS_DIGITAL_DRIVER_FACTORY_H_
#define BINK_MP_INCLUDE_IMSS_DIGITAL_DRIVER_FACTORY_H_
...
#endif  // !BINK_MP_INCLUDE_IMSS_DIGITAL_DRIVER_FACTORY_H_